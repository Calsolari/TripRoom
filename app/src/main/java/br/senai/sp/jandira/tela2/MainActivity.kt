package br.senai.sp.jandira.tela2
...
import br.senai.sp.jandira.tela2.ui.theme.Tela2Theme
    ...
    Column(
        ...
        Column (
            ...
            Box(modifier = Modifier
                ...
                Box(modifier = Modifier){
                    Image(
                        painter = painterResource(id = br.senai.sp.jandira.tela2.R.drawable.eclipse),
                        contentDescription = "",
                ...
                Image(
                    painter = painterResource(id = br.senai.sp.jandira.tela2.R.drawable.vectorcam),
